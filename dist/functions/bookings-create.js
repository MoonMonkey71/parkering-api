...
async function bookingsCreate(request, context) {
    ...
    try {
        ...
        const listingResult = await pool.request()
            .input('listing_id', database_1.sql.UniqueIdentifier, listing_id)
            .query(`
        ...
        const result = await pool.request()
            ...
            .input('start_date', database_1.sql.Date, start_date)
            .input('end_date', database_1.sql.Date, end_date)
            .input('total_price', database_1.sql.Decimal(10, 2), totalPrice)
            .query(`
...
functions_1.app.http('bookingsCreate', {
    methods: ['POST'],
    authLevel: 'function',
    handler: bookingsCreate
});
//# sourceMappingURL=bookings-create.js.map